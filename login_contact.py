...
# Form implementation generated from reading ui file 'login_contact.ui'
#
...
class Ui_Dialog_customer_login(object):
    ...
    def user_authenticate(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT user_name,user_pass FROM user_info where user_id = 2")
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Contacts Login"))
        self.label_2.setText(_translate("Dialog", "Password"))
        self.label.setText(_translate("Dialog", "Contact User"))
